import meanSpectra from '../assets/project-media/raman/mean-spectra.webp'
import benchmark from '../assets/project-media/raman/model-benchmark-cv.webp'
import classificationBenchmark from '../assets/project-media/raman/classification-benchmark.webp'
import confusion from '../assets/project-media/raman/classification-confusion.webp'
import concentration from '../assets/project-media/raman/concentration-classification.webp'
import holdout from '../assets/project-media/raman/concentration-loc-cv.webp'
import regression from '../assets/project-media/raman/regression-per-compound.webp'
import regressionBenchmark from '../assets/project-media/raman/regression-benchmark.webp'
import regressionScatter from '../assets/project-media/raman/regression-scatter.webp'
import jointPipelineScatter from '../assets/project-media/raman/joint-pipeline-scatter.webp'
import peakVsConcentration from '../assets/project-media/raman/peak-vs-concentration.webp'
import spectraByConcentration from '../assets/project-media/raman/spectra-by-concentration.webp'
import concentrationConfusion from '../assets/project-media/raman/concentration-confusion.webp'
import physicsScaled from '../assets/project-media/raman/physics-scaled-spectra.webp'
import mcr from '../assets/project-media/raman/mcr-resolved-spectra.webp'
import physicsConfusionKnn from '../assets/project-media/raman/physics/physics-confusion-knn.webp'
import physicsConfusionLogistic from '../assets/project-media/raman/physics/physics-confusion-logistic.webp'
import physicsConfusionLogisticPerCompound from '../assets/project-media/raman/physics/physics-confusion-logistic-legacy.webp'
import physicsConfusionRandomForest from '../assets/project-media/raman/physics/physics-confusion-random-forest.webp'
import physicsConfusionRandomForestPerCompound from '../assets/project-media/raman/physics/physics-confusion-random-forest-legacy.webp'
import physicsConfusionSvmRbf from '../assets/project-media/raman/physics/physics-confusion-svm-rbf.webp'
