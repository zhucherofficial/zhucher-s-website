...
export const projects = [
  ...
  },
  {
    ...
    detail:
      'The CTB study compared separate Trametes versicolor and Cordyceps militaris treatments of Astragalus extraction residue. After 12 days of fungal fermentation, the treated residue entered feed mixtures at 10% addition for a 6-day mixed-culture fermentation. The original pipeline below connects those steps to the compound assays and feed-quality measurements. Results from the related patent are presented separately because its formulation and fermentation schedule differ.',
    ...
    mediaGroups: [
      {
        ...
        kind: 'photos',
        description: 'Original photographs of the workspace, residue samples, and feed preparation. These document the experiment; the assay figures below report its measurements.',
      },
      {
        id: 'cultures',
        title: 'Cultures and treated material',
        description: 'The CTB manuscript compares Trametes versicolor with Cordyceps militaris. Panel letters are preserved so each culture and sample can be identified.',
      },
      {
        id: 'assays',
        title: 'Original CTB assay figures',
        description: 'These figures belong to the CTB pipeline shown above: 12-day fungal treatment, followed by 6-day feed fermentation at 35°C. They are separate from the patent dataset in sections 04–05.',
      },
    ],
    media: [
      {
        title: 'Laboratory setup',
        caption: 'The project’s benchtop workspace for culture preparation and sample handling.',
        source: 'Original project photograph',
        group: 'laboratory',
        src: astragalusLabBench,
        type: 'image',
      },
      {
        title: 'Fungal cultures and fermented residue',
        caption: 'A: Trametes versicolor. B: Cordyceps militaris. C and D: Astragalus residue fermented with the respective fungi. This is a comparison of cultures, not a chronological sequence.',
        source: 'CTB manuscript · Figure 1',
        group: 'cultures',
        kind: 'figure',
        layout: 'wide',
      ...
      {
        title: 'Residue fermentation samples',
        caption: 'Side-by-side fermentation bags labeled for the two fungal treatments.',
        source: 'Project presentation · Slide 12 photograph',
        group: 'laboratory',
        src: astragalusFermentedDregsPairs,
        type: 'image',
      },
      {
        title: 'Feed formulation in bags',
        caption: 'Feed ingredients and treated residue before mixing. The visible layers document preparation, not a finished product.',
        source: 'Project presentation · Slide 14 photograph',
        group: 'laboratory',
      ...
      },
      {
        ...
        caption: 'End-point comparison of unfermented residue and the two fungal treatments. This is not a day-5 time series.',
        source: 'CTB manuscript · Figure 2 · Concentration in mg/g',
        group: 'assays',
        kind: 'figure',
      ...
      },
      {
        ...
        caption: 'Cellulase activity measured after primary fermentation with Trametes versicolor and Cordyceps militaris. The source figure shows the two fungal treatments.',
        source: 'CTB manuscript · Figure 5 · Activity in U/g',
        group: 'assays',
        kind: 'figure',
      ...
      {
        title: 'Reducing sugar and total sugar',
        caption: 'A: reducing sugar. B: total sugar. The paired plots compare unfermented residue with each fungal treatment.',
        source: 'CTB manuscript · Figure 3 · Original paired panels',
        group: 'assays',
        kind: 'figure',
        layout: 'wide',
      ...
      {
        title: 'Viable counts during feed fermentation',
        caption: 'A: lactic-acid bacteria. B: yeast. The curves follow the control and the two fungal-residue feed groups over the 6-day CTB experiment.',
        source: 'CTB manuscript · Figure 7 · Original paired panels',
        group: 'assays',
        kind: 'figure',
        layout: 'wide',
